...
server 'errors.moku.io', user: 'deploy', roles: %w[web app db], primary: true, my_property: :my_value

# Nginx settings
set :nginx_domains, 'errors.moku.io'
...
set :lets_encrypt_domains, 'errors.moku.io'
